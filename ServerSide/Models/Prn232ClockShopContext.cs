...
public partial class Prn232ClockShopContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Carts__51BCD79712345678");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Carts)
                ...
                .HasConstraintName("FK__Carts__Customer__12345678");

            entity.HasOne(d => d.Product).WithMany(p => p.Carts)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Carts__Product__12345679");
        });
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.Supplier).WithMany(p => p.Products)
                ...
                .OnDelete(DeleteBehavior.SetNull) // Set null khi supplier bị xóa
                .HasConstraintName("FK__Products__Suppli__5441852A");
        });

        modelBuilder.Entity<Supplier>(entity =>
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__4BE666B4");
